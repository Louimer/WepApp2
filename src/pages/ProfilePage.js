            ...
            <div className="profile-page">
                    ...
                    <h3>Min bruger</h3>
                        ...
                        <div className="profile-btn-cntr">
                           <button className="btn" onClick={handleSignOut} data-id={user.id}>Log ud</button>
                    ...
                    <form onSubmit={submitEvent}>
                        ...
                        <div className="group-members-box">
                            ...
                            <div className="group-members-details">
                                <input type="text" className="group-member" value={user?.name} name="name" placeholder={`${user?.name}`} />
                                <input type="email" className="group-member" value={user?.email} name="email" placeholder={`${user?.email}`} />
                            </div>
                            <button className="remove-btn" onClick={handleUserDelete} data-id={user.id}><HiMinusCircle /></button>
                        </div>
                        ...
                        <div className="group-members-box">
                            ...
                            <button className="remove-btn" onClick={handleUserDelete} data-id={user.id}> <HiMinusCircle /> </button> {/* OBS - pt slet user knap */}
                        </div>
